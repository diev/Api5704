...
'ИНН
Const INN As String = "783100xxxx"

'ОГРН
Const OGRN As String = "102780000xxxx"
...
'ПолноеНаименование
Const BANK As String = "АКЦИОНЕРНОЕ ОБЩЕСТВО ""xxxx xxxxСТ БАНК"""

'СокращенноеНаименование
Const BNK As String = "АО ""xxxx xxxxСТ БАНК"""
...
Public Sub CreateDlRequest()
    ...
    Set request = XDoc.createElement("Запрос")
        ...
        'уступленных специализированному финансовому обществу или ипотечному агенту
